...
const defaultSongs = {
  English: [
    ...
    { title: "Believer", artist: "Imagine Dragons", fileUrl: "/uploads/believer.mp3" }
  ],
  Telugu: [
    ...
    { title: "Inkem Inkem Inkem Kaavaale", artist: "Sid Sriram", fileUrl: "/uploads/inkem.mp3" }
  ],
  Hindi: [
    ...
    { title: "Apna Bana Le", artist: "Arijit Singh", fileUrl: "/uploads/apna_bana_le.mp3" }
  ]
};
...
router.get("/:language", async (req, res) => {
  ...
  try {
    ...
    if (songs.length > 0) {
      ...
      // Send default songs if DB empty
      return res.json(defaultSongs[language] || []);
    }
  } catch (err) {
